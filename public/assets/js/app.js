(function($) {
    ...
    if ($.fn.meanmenu) {
        $('nav#dropdown').meanmenu({
            siteLogo: "<div class='mobile-menu-nav-back' id='logo-mobile-1'><a class='logo-mobile' href='index.html'><img src='media/logo-dark.png' alt='logo' class='img-fluid'/></a></div>"
        });
    }
