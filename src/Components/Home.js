      ...
      <div id="wrapper" className="wrapper">
        ...
        <div id="main_content">
                  ...
                  <svg width="678px" height="575px">
                    <defs>
                      ...
                      >
                        <stop
                          offset="0%"
                          stopColor="rgb(82,63,255)"
                          stopOpacity="0.21"
                        />
                        <stop
                          offset="100%"
                          stopColor="rgb(104,2,198)"
                          stopOpacity="0.21"
                        />
                      </linearGradient>
                    </defs>
                  ...
                  <div className="translate-right-75 opacity-animation transition-150 transition-delay-2600">
                    <div className="main-banner-box-layout1">
                      <div className="item-figure">
                        <img
                          src="media/illustration/illustration1.png"
                          alt="Illustration"
                        />
                      </div>
                    </div>
                ...
                <div className="col-lg-7 order-lg-1 compress-left-side d-flex align-items-center">
                  <div className="main-banner-box-layout1">
                    ...
                    <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-2100">
                      <p>
                        <b>--Turning your VISION into VALUE--</b>
                      </p>
                    </div>
                    <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-2400">
                      <div className="banner-btns">
                        <a
                          href="register.html"
                          className="item-btn btn-ghost btn-light"
                        >
                          Join Us
                        </a>
                        <a
                          className="play-btn popup-youtube"
                          href="https://www.youtube.com/watch?v=xf34GCMVAoY"
                        >
            ...
            <div className="animated-shape">
              <ul>
                <li>
                  <div className="translate-right-75 opacity-animation transition-200 transition-delay-500">
                    <img
                      src="media/element/element11.png"
                      alt="Animated Figure"
                    />
                  </div>
                </li>
                    ...
                    <div className="item-content">
                      ...
                      <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-1500">
                        <h2 className="item-title">
                          Fueling Curious Minds And Providing a Platform to
                          Thrive
                        </h2>
                      </div>
                      <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-2000">
                        <p>
                          CIIE facilitates innovation through research and
                          collaboration by translating domain expertise into
                          products or technologies. We at CIIE foster
                          entrepreneurial spirit and promote start-ups by
                          providing appropriate incubation facilities, offering
                          consultancy services and improving industry-institute
                          interaction.{" "}
                        </p>
                      </div>
                      <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-2500">
                        <a href="about.html" className="btn-fill btn-gradient">
                          Discover More<i className="flaticon-next"></i>
                        </a>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="translate-right-75 transition-150 opacity-animation transition-delay-100">
                          <div className="d-flex align-items-sm-center">
                            ...
                            <div className="item-content">
                              ...
                              <p>
                                For students passionate about turning their
                                ideas into action. Sign up to help us help you
                        ...
                        <div className="translate-left-75 transition-150 opacity-animation transition-delay-1000">
                          <div className="d-flex align-items-sm-center flex-xl-row-reverse">
                            ...
                            <div className="item-content">
                              ...
                              <p>
                                For the budding makers willing to ride the
                                exciting road to become successful
                                entrepreneurs. Sign up for relentless support.
                              </p>
                              <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-2500">
                                <a
                                  href="incubate.html"
                        ...
                        <div className="translate-right-75 transition-150 opacity-animation transition-delay-2000">
                          <div className="d-flex align-items-sm-center">
                            ...
                            <div className="item-content">
                              ...
                              <p>
                                For industry experts and professionals willing
                                to inspire our incubates. Sign up as mentors to
          ...
          <section className="service-wrap-layout1 section-padding-md bg-color-accent2 position-relative">
            ...
            <div className="container">
              <div className="section-heading heading-dark heading-layout1 has-animation">
                <h2 className="heading-main-title" id="facilities">
                  WHAT WE DO
                </h2>
                <div className="heading-icon">
                  <svg className="dash-left" width="100" height="20">
                  ...
                  <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-100">
                    <div className="service-box-layout1">
                      ...
                      <h3 className="item-title">
                        <a href="service-details.html">Grants Office</a>
                      </h3>
                      <p>
                        Guidance offered to draft proposals for government
                        grants
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-sm-6 col-12 masonry-item has-animation">
                  <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-300">
                    <div className="service-box-layout1">
                      ...
                      <h3 className="item-title">
                        <a href="service-details.html">Financial Aid</a>
                      </h3>
                      <p>
                        Aid assistance offered for the development of Proof of
                        Concept
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-sm-6 col-12 masonry-item has-animation">
                  <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-500">
                    <div className="service-box-layout1">
                      ...
                      <p>
                        We help with filing Patents, Technology transfer and
                        Agreements/ MoUs
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-sm-6 col-12 masonry-item has-animation">
                  <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-100">
                    <div className="service-box-layout1">
                      ...
                      <p>
                        Networking support and consulting services from our
                        advisors and mentors with diverse experience
                      </p>
                      <br /> <br />
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-sm-6 col-12 masonry-item has-animation">
                  <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-300">
                    <div className="service-box-layout1">
                      ...
                      <p>
                        Access provided to equipment available in the institute
                        without affecting regular academic activity
                      </p>{" "}
                      <br />
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-sm-6 col-12 masonry-item has-animation">
                  <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-500">
                    <div className="service-box-layout1">
                      ...
                      <p>
                        We provide you a platform to translate your ideas to
                        prototypes and transform them into viable products,
                        along with low volume manufacturing support
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 col-sm-6 col-12 masonry-item has-animation">
                  <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-500">
                    <div className="service-box-layout1">
                      ...
                      <h3 className="item-title">
                        <a href="service-details.html">Licensed Software</a>
                      </h3>
                      <p>
                        Guidance offered towards the usage of Design and
                        Simulation Software
                      </p>{" "}
                      <br /> <br />
                    </div>
                ...
                <div className="col-lg-4 col-sm-6 col-12 masonry-item has-animation">
                  <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-500">
                    <div className="service-box-layout1">
                      ...
                      <p>
                        Access provided to the utilization of 3D Printers, PCB/
                        Metal Fabrication, CNC, Plastic Molding, etc.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 col-sm-6 col-12 masonry-item has-animation">
                  <div className="translate-bottom-75 opacity-animation transition-150 transition-delay-500">
                    <div className="service-box-layout1">
                      ...
                      <p>
                        We offer assistance in digital/ B2B marketing while
                        scaling up to increase and improve reach towards
