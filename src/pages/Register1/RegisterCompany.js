            ...
            <>
                ...
                <div className="main-content">
                    ...
                    <section className='register-form'>
                        ...
                        <button className='btn' onClick={() => showForm('form1')}>Guide</button>
                        <button className='btn' onClick={() => showForm('form2')}>Incubate</button>
                        <button className='btn' onClick={() => showForm('form3')}>Help</button>
                        </div>
                        {/* Form 1 */}
                        {activeForm === 'form1' && (
