            ...
            <div>
                {/*<div id="preloader" className="tlp-preloader">
                    <div className="animation-preloader">
                        ...
                        <img src="/images/about/about1.jpg" alt="Preloader" />
                    </div>
                </div>
                                        ...
                                        <div className="col-lg-2 d-flex justify-content-start">
                                            <div className="temp-logo text-center">
                                                <a href="index.html" className="default-logo">
                                                    <img src="media/CIIE white font png-02.png" alt="logo" className="img-fluid"
                                                        style="height: 80px;" />
                                                    <p style="color: white;"><b>An Initiative by BMSCE</b></p>
                                                </a>
                                                <a href="index.html" className="sticky-logo" />
                                                <img src="media/logo-dark.png" alt="logo" className="img-fluid"
                                                    style="height: 80px;"/>
                            ...
                            <div className="row justify-content-center">
                                <div className="col-11 col-sm-10 col-md-10 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
                                    <div className="card px-0 pt-4 pb-0 mt-3 mb-3">
                                        ...
                                        <form action="https://send.pageclip.co/XBKl1XrdmIl6njy9wNVrC78taONyei7z/ciie-Registration" className="pageclip-form" method="post" />
                                        <div className="container">
                                            ...
                                            <p><b>
                                                Role</b>
                                                <select className="select" name="Dept">
                                                    <option value="">-- Select Your Role --</option>
                                                    <option value="Innovator" name="Innovator">Innovator (Want to Pitch your Ideas)</option>
                                                    <option value="Incubator" name="Incubator">Incubator (Want to Support Our Student's Startups)</option>
                                                    <option value="Mentor" name="Mentor">Mentor (Want to mentor our Students)</option>
                                                    <option value="Volunteer" name="Volunteer">Volunteer (Want to Volunteer CIIE team)</option>
                                    ...
                                    <div className="col-xl-3 col-lg-2 d-xl-block">
                                        <div className="footer-widgets">
                                            ...
                                            <ul className="footer-contact">
                                                <li><i className="flaticon-placeholder"></i>CIIE: BMS College of Engineering Bull Temple
                                                    Road, Basavanagudi, Bangalore- 560019</li>
                        ...
                        <div className="footer-bottom-layout1 bg-color-accent">
                            <div className="container">
                                <div className="copy-right-wrap">
                                    <p className="copy-right-text">© 2021 <a href="https://www.radiustheme.com/" rel="nofollow"
                                        target="_blank">CIIE BMSCE</a> All Rights Reserved</p>
                                </div>
                            </div>
                        </div>
                    </footer>
