            ...
            <div>
                ...
                <div id="wrapper" className="wrapper">
                    ...
                    <div id="main_content">
                                ...
                                <div className="navbar-layout1">
                                    <div className="container">
                                        <div className="row no-gutters d-flex align-items-center position-relative">
                                            ...
                                            <div className="col-lg-9 d-flex justify-content-end possition-static">
                        ...
                        <div class="container position-relative" style={{maxWidth:"100%",display:"flex"}}>

                            <div class="row d-flex justify-content-center" style={{width:"140%",display:"flex",justifyContent:"center",alignItems:'center'}}>
                                <div class="col-md-6 col-xl-4">
                                    <div class="d-flex flex-column justify-content-center align-items-start h-100">
                                        <div class="d-flex align-items-center p-3">
                                            <div class="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md"><svg class="bi bi-telephone" xmlns="http://www.w3.org/2000/svg" width="em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                                        ...
                                        <div class="d-flex align-items-center p-3">
                                            <div class="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md"><svg class="bi bi-envelope" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                                                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z"></path>
                                            </svg></div>
                                            <div class="px-2">
                                                <h6 class="font-weight-bold mb-0">Email</h6>
                                                <p class="mb-0">ciie@bmsce.ac.in</p>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center p-3">
                                            <div class="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon bs-icon-md"><svg class="bi bi-pin" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16">
                                            ...
                                            <div class="px-2">
                                                <h6 class="font-weight-bold mb-0">Our Location</h6>
                                                <p class="mb-0">CIIE: BMS College of Engineering Bull Temple Road, Basavanagudi, Bangalore- 560019</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-xl-4">
                                    <div>
                                        <form class="p-3 p-xl-4" method="post">
                                            <div class="mb-3"><input id="name" class="form-control" type="text" name="name" placeholder="Name" /></div>
                                            <div class="mb-3"><input id="email" class="form-control" type="email" name="email" placeholder="Email" /></div>
                                            <div class="mb-3"><input id="subject" class="form-control" type="text" name="name" placeholder="Subject" /></div>
                                ...
                                <div className="container">
                                    <div className="row">
                                        ...
                                        <div className="col-xl-3 col-lg-3 col-md-6 col-12">
                                            <div className="footer-widgets">
                                                <h3 className="footer-widget-heading"></h3>
                                                <p></p>
                                                <ul className="footer-contact">
